...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/nelluru-jaswanth-a611ba2b3/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@Jaswanth._",
    icon: Instagram,
    url: "https://www.instagram.com/jaswanth_a_r_j_u_n/?igsh=eWs1YnM2YjVyd29m#",
    color: "#E4405F",
  ...
  },
  {
    name: "YouTube",
    displayName: "Youtube",
    subText: "@NelluruJaswanth",
    icon: Youtube,
    url: "https://www.youtube.com/@NelluruJaswanth",
    color: "#FF0000",
  ...
  },
  {
    ...
    subText: "@Jaswanth",
    icon: Github,
    url: "https://github.com/Jaswanth-arjun",
    color: "#ffffff",
